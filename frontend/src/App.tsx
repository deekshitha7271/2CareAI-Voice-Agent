...
const MicSVG = () => (
  <svg viewBox="0 0 24 24" className="mic-icon" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/>
    <path d="M19 10v2a7 7 0 0 1-14 0v-2" stroke="var(--accent-cyan)" strokeOpacity="0.8"/>
    <line x1="12" y1="19" x2="12" y2="23" stroke="var(--accent-cyan)" strokeOpacity="0.8"/>
    <line x1="8" y1="23" x2="16" y2="23" stroke="var(--accent-cyan)" strokeOpacity="0.8"/>
  </svg>
);
      ...
      <aside className="sidebar">
        <div className="brand">
          <div className="logo-container">
            <img src="/logo.png" alt="2Care.ai Logo" />
          </div>
        </div>
